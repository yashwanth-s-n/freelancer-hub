...
const jobs = [
  ...
  },
  {
    ...
    "image": "https://www.thoughtlabs.com/hubfs/https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQA3suYcRY0UTMLONzjPOMtellCj-6xQ-he0g&s.jpg"
  },
  {
    "id": 13,
  ...
  },
  {
    ...
    "image": "https://www.kmd-solutions.com/uploads/1/3/0/9/130962573/what-does-technical-writer-do_orig.png"
  },
  {
    "id": 22,
...
const JobDetails = () => {
  ...
  const handleApplyClick = () => {
    // Redirect to the application form page, passing the job ID
    navigate(`/apply/${id}`);
  };
  ...
  return (
    <div className="job-details-container">
      ...
      <div className="job-details-content">
        ...
        <p>Price: {job.price}</p>
        <p>{job.description}</p>
        <button className="hire-btn" onClick={handleApplyClick}>Apply {job.freelancer}</button>
      </div>
    </div>
  );
};
